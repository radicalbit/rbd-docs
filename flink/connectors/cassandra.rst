...
.. literalinclude:: /rbp-docs-code/flink/cassandra-connector-example/pom.xml
    :caption: pom.xml
    :language: xml
    :lines: 89-93
    :name: pom.xml
...
.. literalinclude:: /rbp-docs-code/flink/cassandra-connector-example/src/main/java/io/radicalbit/CassandraConnectorExample.java
